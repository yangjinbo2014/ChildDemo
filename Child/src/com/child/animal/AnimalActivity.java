...
import com.child.baseui.GenerBottomPreView;
import com.child.baseui.GenerTopSelectView;
...
public class AnimalActivity extends ActionBarActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ((ViewGroup)findViewById(R.id.activity_top_are)).addView(topSelectView.getView());
        ((ViewGroup)findViewById(R.id.activity_bottom_are)).addView(bottomPreView.getView());
    }
